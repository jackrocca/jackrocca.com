...
export default function Privacy() {
  return (
    ...
    >
      ...
      <h1 className="mb-7 mt-10 text-3xl font-medium tracking-tight">Privacy</h1>
      <p>
      ...
      <p>
        We receive your verified email address, Google account identifier, and name. These
        identify your account and let you sign in again. You can change the display name
        other players see. We do not request access to Gmail messages, contacts, or Google
        Drive, and do not store your Google password or Google access tokens.
      </p>
      <h2>League information</h2>
      <p>
        Your display name, standings, and results are visible to signed-in league members.
        Picks are hidden from other players until the weekly deadline. Your email address
      ...
      <p>
        ...
        HTTP-only session cookie keeps you signed in for up to 14 days; a temporary cookie
        protects Google sign-in. Hosting services may process request metadata to operate
        the service. The app does not use advertising or analytics cookies.
      </p>
      <h2>External sites</h2>
      <p>
        Links to Substack, GitHub, and other sites take you to services with their own
        privacy practices. Following the Substack link does not subscribe you or share
        your website account with Substack.
      </p>
      ...
      <p>
        ...
        to request access to, correction of, or deletion of your account information.
      </p>
    </main>
  );
}
