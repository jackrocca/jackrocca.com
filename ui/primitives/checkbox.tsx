...
const Checkbox = ({
  ...
  >
    <CheckboxPrimitive.Indicator
      ...
      keepMounted
      className="flex items-center justify-center text-current transition-[opacity,scale] duration-150 data-unchecked:scale-95 data-unchecked:opacity-0 motion-reduce:transition-none"
    >
      {indeterminate ? (
