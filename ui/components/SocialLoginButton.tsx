...
import { socialLoginProviders } from "@/ui/components/social-login-providers";
import type * as ProviderTypes from "@/ui/components/social-login-providers";
    ...
    <CustomButton
      ...
      className={cn(
        ...
        variant === "outline"
          ...
          : brandClassName,
        iconOnly &&
          cn(iconSizes[size], "max-h-none min-h-0 max-w-none min-w-0 shrink-0 px-0"),
        className,
      )}
    >
