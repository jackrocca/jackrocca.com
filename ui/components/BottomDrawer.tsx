      ...
      >
        ...
        <Drawer.Portal>
          <Drawer.Backdrop
            ...
            className={cn(
              "fixed inset-y-0 left-0 z-[9999] w-screen bg-black/40 opacity-[calc(1-var(--drawer-swipe-progress,0))] transition-opacity duration-[250ms] ease-(--ease-drawer) data-ending-style:opacity-0 data-starting-style:opacity-0 data-swiping:duration-0 motion-reduce:transition-none dark:bg-black/60",
              classNames?.overlay,
            )}
          />
          <Drawer.Viewport
          ...
          >
            <Drawer.Popup
              ...
              className={cn(
                ...
                "pointer-events-auto max-h-[90dvh] max-w-[500px] transform-[translateY(var(--drawer-swipe-movement-y,0px))] transition-transform duration-[250ms] ease-(--ease-drawer) outline-none data-ending-style:translate-y-full data-starting-style:translate-y-full data-swiping:duration-0 motion-reduce:transition-none",
                classNames?.content,
                {
                  "pt-6": !noHeader,
                },
