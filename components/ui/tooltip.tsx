  ...
  <TooltipPrimitive.Portal>
    ...
    >
      <TooltipPrimitive.Popup
        ...
        className={cn(
          "bg-primary text-primary-foreground z-50 origin-(--transform-origin) overflow-hidden rounded-md px-3 py-1.5 text-xs transition-[opacity,scale] duration-150 ease-out data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0 motion-reduce:transition-none",
          className,
        )}
        {...props}
      >
