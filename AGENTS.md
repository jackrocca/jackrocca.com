...
- The component library is public at `/ui` and driven by `lib/ui-catalog.ts`. For any `ui/` change use the skills in `.agents/skills/`: `rockui-build-component`, `rockui-adopt-upstream`, `rockui-document-component`.
