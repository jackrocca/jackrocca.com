...
| `components/`                    | Site and league compositions, providers, the public RockUI library at /ui                  |
...
removed for now; Projects contains two minimal cards, Pick 4 and RockUI (`/ui`). The site header exposes Projects and Account through a hamburger menu at every
